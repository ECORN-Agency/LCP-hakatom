...
function buildRecommendationClient({
  eventType,
  revenueDeltaPct,
  ordersDeltaPct,
  aovDeltaPct,
...
export default function Analytics() {
  ...
  const observedChange = observedChangeData ? {
    ...observedChangeData,
    recommendation: observedChangeData.waiting ? null : buildRecommendationClient({
          ...
          <s-stack id="events-list" gap="small">
            {events.map((event) => {
              ...
              const eventObservedChange = eventObservedChangeData ? {
                ...
                recommendation: eventObservedChangeData.waiting ? null : buildRecommendationClient({
